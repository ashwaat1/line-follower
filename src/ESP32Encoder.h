...
public:
	...
	int_fast32_t getCount();
	int_fast32_t clearCount();
	int_fast32_t pauseCount();
	int_fast32_t resumeCount();
	void detach();
	[[deprecated("Replaced by detach")]] void detatch();
	bool isAttached(){return attached;}
	void setCount(int_fast32_t value);
